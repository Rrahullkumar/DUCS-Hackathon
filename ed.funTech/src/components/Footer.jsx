      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-cyan-400">Ed.FunTech</h3>
